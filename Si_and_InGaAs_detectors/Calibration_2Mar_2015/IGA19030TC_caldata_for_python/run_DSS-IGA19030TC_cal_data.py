...
if __name__ == "__main__":  
  ...
  out_data1=Get_DSS_IGA19030TC_new('Kalibrering_DSS-IGA19030TC.txt').getdata()
  out_data2=Get_DSS_IGA19030TC_old('Kalibrering_DSS-IGA19030TC_HORIBA.txt').getdata()
  out_data3=Get_DSS_IGA19030TC_new('Kalibrering_DSS-IGA19030TC_crosscheck.txt').getdata()
  ...
  plt.title('Calibration of DSS-IGA19030TC (Serial No. 031114) at Justervesenet (JV), Jan 2015')
  ...
  plt.savefig('DSS-IGA19030TC_calplots.pdf')
  plt.show()  
