...
class Run_gui(QtGui.QDialog):
	...
	def initUI(self):
		...
		self.runstopButton = QtGui.QPushButton("START",self)
		...
		g5_1.addWidget(self.runstopButton,0,0)
		g5_1.addWidget(self.clearButton,0,1)
	...
	def createTable(self):
		...
		#tableWidget.setItem(0,0, QtGui.QTableWidgetItem("abe"))
		
		tableWidget.setHorizontalHeaderLabels(["Point no.","Thickness[As]","U[mV]"])
	...
	def make_update2(self,As,volts,timelist):
		...
		# add row elements
		self.tableWidget.setItem(self.tal, 0, QtGui.QTableWidgetItem(str(self.tal)))
		self.tableWidget.setItem(self.tal, 1, QtGui.QTableWidgetItem(str(int(As))))
		self.tableWidget.setItem(self.tal, 2, QtGui.QTableWidgetItem(str(volts)))
