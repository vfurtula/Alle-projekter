...
# without applying the carrier function T_alpha. In most cases two iterations are enough to 
# find extrema points at their proper locations.
num_periods = 2
iterations = 2
...
save_analysis_folder = 'ek072-1_analysis'
