...
class Find_extrema:
	...
	def __init__(self):
		...
		self.folder_str, self.filename_str, self.raw_olis, self.raw_ftir, self.sub_olis, self.sub_ftir=gtt.folders_and_data()
	...
	def get_T_alpha(self):
	  ...
	  # Save the required data in new lists and make a return
		...
		return indicies, comax_alph_TalTalflat, com_axisTminTmax_first, com_axisTminTmax_final, all_extremas
	...
	def make_plots(self):
		...
		indicies, comax_alph_TalTalflat, com_axisTminTmax_first, com_axisTminTmax_final, all_extremas = self.get_T_alpha()

		indx_start, indx_end = indicies
		common_xaxis, Tmin, Tmax = com_axisTminTmax_first
