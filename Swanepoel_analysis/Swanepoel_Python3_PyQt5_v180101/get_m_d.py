...
class Gmd:
	...
	def make_plots(self):
		...
		if self.gw.save_figs:
			string_3 = ''.join([self.gw.filename, '_n1_n2_', self.gw.fit_linear_spline,'_', self.gw.timestr, '.png'])
		...
		string_4 = ''.join([self.gw.filename, '_n_', self.gw.fit_linear_spline,'_', self.gw.timestr, '.txt'])
