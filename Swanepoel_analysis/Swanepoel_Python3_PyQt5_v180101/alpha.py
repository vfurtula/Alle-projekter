...
import get_Tmax_Tmin, get_m_d, get_raw
...
class Alpha:
	...
	def __init__(self):
		...
		self.gtt = get_Tmax_Tmin.Get_Tmax_Tmin()
	...
	def make_plots(self):
		...
		string_1 = ''.join([self.gw.filename, '_alpha_', self.gw.fit_linear_spline,'_', self.gw.timestr, '.png'])
		...
		if self.gw.save_figs:
			string_3 = ''.join([self.gw.filename,'_n2_', self.gw.timestr,'.png'])
