...
class Get_Tmax_Tmin:
	...
	def make_plots(self):
		...
		if self.gw.save_figs:
			string_2 = ''.join([self.gw.filename,'_Tr_subfilm (', self.gw.fit_linear_spline , ')_',self.gw.timestr, '.png'])
		...
		if self.gw.save_figs:
			string_3 = ''.join([self.gw.filename, '_Tr_sub (', self.gw.fit_linear_spline , ')_',self.gw.timestr, '.png'])
		...
		if self.gw.save_figs:
			string_4 = ''.join([self.gw.filename, '_Tr_flatten (', self.gw.fit_linear_spline , ')_',self.gw.timestr, '.png'])
