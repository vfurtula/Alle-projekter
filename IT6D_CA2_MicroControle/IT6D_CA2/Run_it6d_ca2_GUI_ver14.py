...
class Run_IT6D_CA2_Thread(QThread):
	...
	def gauss(self,x,p): #p[0]==mean, p[1]==stdev, p[2]==peak height
		...
		return self.fit_he*numpy.exp(-(x-self.mean)**2/(2*p[0]**2))+self.fit_noise
...
class Run_IT6D_CA2(QtGui.QWidget):
	...
	def update_Spath(self,umax_X_lsf,umax_Y_lsf,S,Umax):
		...
		self.curve6.setData(S,numpy.log10(Umax))
		self.curve8.setData(umax_X_lsf,numpy.log10(umax_Y_lsf))
