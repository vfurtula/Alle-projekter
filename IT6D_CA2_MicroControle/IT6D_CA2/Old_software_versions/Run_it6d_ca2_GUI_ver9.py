...
class Run_IT6D_CA2(QtGui.QWidget):
	...
	def initUI(self):
		...
		self.sld_amp.setRange(0.01,0.5)
		self.sld_amp.setSingleStep(0.01)
		self.sld_amp.setPageStep(0.05)
		self.sld_amp.setValue(self.lockin_volt)
	...
	def changeAmp(self, val):
		...
		self.lockin_volt=float(val)
		self.amp_lbl.setText(''.join(["Osc. Vpk-pk (",str(val),") [V]"]))
		self.sr810.set_intrl_volt(float(val))
		time.sleep(0.05)
