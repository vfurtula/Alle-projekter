...
if op_mode=='xyscan':
  xstart=int(params.xstart_mm*1000)
  xend=int(params.xend_mm*1000)
  xstep=int(params.xstep_mm*1000)
  ystart=int(params.ystart_mm*10000)
  yend=int(params.yend_mm*10000)
  ystep=int(params.ystep_mm*10000)
...
elif op_mode in ['absx','relx']:
  move_axis=int(params.move_axis_mm*1000)
  xy_limiter=int(params.xy_limiter_mm*1000)
elif op_mode in ['absy','rely']:
  move_axis=int(params.move_axis_mm*10000)
  xy_limiter=int(params.xy_limiter_mm*1000)
else:
