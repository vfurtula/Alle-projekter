...
import SR5210_rs232, IT6D_CA2_gpib
...
class Run_IT6D_CA2(QtGui.QWidget):
	...
	def set_connect(self):
		...
		try:
			...
			self.sr5210.set_timeout(1)
			self.sr5210.return_id()
			self.sr5210.set_timeout(None)
		
		except Exception, e:
			QtGui.QMessageBox.warning(self, 'Message',"No response from SR5210! Check the port name and check the com- and power lines.")
